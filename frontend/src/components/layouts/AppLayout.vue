<template>
  <div class="min-h-screen flex flex-col">
    ...
    >
      ...
      <div class="flex items-center gap-2">
        <!-- Icona search visibile solo su mobile: porta alla pagina /me/search
             dove il form è dedicato a tutta la larghezza. -->
        <RouterLink
          to="/me/search"
          class="sm:hidden w-9 h-9 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 flex items-center justify-center"
          aria-label="Cerca"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
